...
class CustomComp extends Component {
    ...
    render() {
        const { proDate, team, data, crusher, currentCrusher, runTime, remark, message, submitType, visable, showSlider, selectType } = this.state;
        const components = {
            body: {
                row: EditableFormRow,
                cell: EditableCell,
        ...
        console.log(team, currentCrusher)
        return (
