...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        if (serchQuery.code) {
            ...
            scriptUtil.excuteScriptService({
                objName: "ZLGL",
                serviceName: "getFinalResult_WJSN",
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <div style={topDivContainerStyle}>
                    <div style={topTitleStyle}>水泥品种</div>
    ...
    handleOpenAnalysisResult = () => {
        window.top.zhizhiDispatchAppEvent('reqOpenPublicAccount', {
            ...
            title: '',
            // 下一个页面的URL
            url: `http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_b540c2f73e544615bc72537e9d2b9030?code=${this.state.mainInfo.orderCode} `
        })
    }
    //保存主子表
    saveInfo = () => {
