...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        if (code) {
            ...
            scriptUtil.excuteScriptService({
                objName: "ZLGL",
                serviceName: "getFinalResult_RYMF",
                params: { "code": code },
                cb: (res) => {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <div style={topDivContainerStyle}>
                    <div style={topDescStyle}>{mainInfo.scName}</div>
    ...
    handleOpenAnalysisResult = () =>{
        window.top.zhizhiDispatchAppEvent('reqOpenPublicAccount', {
            ...
            title: '',
            // 下一个页面的URL
            url: `http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_1dc0300e47034b9dbfd329e87b7c8a72?code=${this.state.mainInfo.code} `
        })
    };
