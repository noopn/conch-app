...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            params: { category: '生料', factory: '制造一', recordingTime: serchQuery.recordingTime.split(' ')[0], team: serchQuery.team },
            cb: (res) => {
                this.setState({
    ...
    handleSaveClick = () => {
        ...
        Promise.all(this.state.dataSections.map(item => new Promise((resolve, reject) => {
            const updateData = {
                ...
                where: { category: '生料', factory: '制造一', recordingTime: this.state.recordingTime, team: this.state.team, id: item.id },
            };
            scriptUtil.excuteScriptService({
            ...
            scriptUtil.openPage('/#/runtime-fullscreen/runtime-fullscreen/Page_b52a7f23e9d9449687f17586a73897d5', '_self')
        })
    }
