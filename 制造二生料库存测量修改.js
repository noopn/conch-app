...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            params: { category: '生料', factory: '制造二', recordingTime: serchQuery.recordingTime.split(' ')[0], team: serchQuery.team },
            cb: (res) => {
                this.setState({
    ...
    handleSaveClick = () => {
        ...
        Promise.all(this.state.dataSections.map(item => new Promise((resolve, reject) => {
            const updateData = {
                ...
                where: { category: '生料', factory: '制造二', recordingTime: this.state.recordingTime, team: this.state.team, id: item.id },
            };
            scriptUtil.excuteScriptService({
            ...
            scriptUtil.openPage('/#/runtime-fullscreen/runtime-fullscreen/Page_b1da52d38b474c6e88c82f8deb1fadb7', '_self')
        })
    }
