        ...
        return (
            ...
            >
                ...
                {this.state.data.map(section => (
                    <div style={topDivContainerStyle}>
                        <div style={topDescStyle}
                            onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_0eccf764eb364840aac06114f0477198?recordingTime=${section.recordingTime}&team=${section.team}`, '_self')}
                        >
                ...
                <div style={btnContainerStyle}>
                    <Button style={saveBtnStyle} onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_5990f4da27c649c098b76b065a5f683e`, '_self')}> 新增 </Button>
                </div>
            </div>
        );
    }
