...
class CustomComp extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <div style={topDivContainerStyle}>
                    <div style={topTitleStyle}>煤粉编号</div>
    ...
    setDynamicCode = (scDate, MFNum) => {
        scriptUtil.excuteScriptService({
            objName: "ZLGL",
            serviceName: "getDynamicCode_RYMF",
    ...
    saveInfo = () => {
        ...
        const params = {
            ...
            "typeName": "RYMF", "typeShowName": "入窑煤粉", "scName": mainInfo.MFNum, "scShowName": mainInfo.MFName,
