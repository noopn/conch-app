        ...
        scriptUtil.excuteScriptService({
            ...
            cb: (res) => {
                ...
                res.result.data.dataSource.find(item => item.orderCode === section.orderCode) ?
                    scriptUtil.openPage(`http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_a32a4b40ccd5497db074d930e477b922?code=${section.code}&orderCode=${section.orderCode}&createTime=${section.createTime}`, '_self') ://修改页面
                    scriptUtil.openPage(`http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_ff1c06c7977d465fa28f25934fae10c1?code=${section.code}&orderCode=${section.orderCode}&createTime=${section.createTime}`, '_self')//新建页面
            }
        });
