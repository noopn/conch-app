...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            serviceName: "querycementSampleAutoCodeSQLExec1",
            params: inputs,
            cb: (res) => {
        ...
        scriptUtil.excuteScriptService({
            ...
            cb: (res) => {
                res.result.data.dataSource.find(item => item.orderCode === section.orderCode) ?
                    scriptUtil.openPage(`http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_001552101a084a139b0977ed08bbab8b?code=${section.code}&orderCode=${section.orderCode}&createTime=${section.createTime}`, '_self') ://修改页面
                    scriptUtil.openPage(`http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_3cf9a0e871c042278f5604afac16d4b9?code=${section.code}&orderCode=${section.orderCode}&createTime=${section.createTime}`, '_self')//新建页面
            }
        });
