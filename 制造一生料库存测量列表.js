...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            params: { category: '生料', factory: '制造一' },
            cb: (res) => {
        ...
        return (
            ...
            >
                ...
                {this.state.data.map(section => (
                    <div style={topDivContainerStyle}>
                        <div style={topDescStyle}
                            onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_463eb8e5cbc74a419230472b4fbafe09?recordingTime=${section.recordingTime}&team=${section.team}`, '_self')}
                        >
                ...
                <div style={btnContainerStyle}>
                    <Button style={saveBtnStyle} onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_318fa76b6a7a42079d7e1cf613b4b56f`, '_self')}> 新增 </Button>
                </div>
            </div>
        );
    }
