...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            mainInfo: {
                ...
                snName: slMap[serchQuery.code.substr(2, 2)],
        ...
        if (serchQuery.code) {
            ...
            scriptUtil.excuteScriptService({
                objName: "ZLGL",
                serviceName: "getFinalResult_CCSL",
    ...
    handleOpenAnalysisResult = () => {
        window.top.zhizhiDispatchAppEvent('reqOpenPublicAccount', {
            ...
            title: '',
            // 下一个页面的URL
            url: `http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_0f99ecff315b4ded90689585686fbf31?orderCode=${this.state.mainInfo.orderCode} `
        })
    }
    //保存主子表
    saveInfo = () => {
