        ...
        return (
            ...
            >
                ...
                {this.state.data.map(section => (
                    <div style={topDivContainerStyle}>
                        <div style={topDescStyle}
                            onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_9bbe64ab3d7c4cdd88827a859b922018?date=${section.recordtime}&code=${section.whcode}`, '_self')}
                        >
                            {section.whname}
                        </div>
                        <div style={topDescStyle}>
                ...
                <div style={btnContainerStyle}>
                    <Button style={saveBtnStyle} onTouchStart={()=>scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_34d31128f30f4b6d9b59bff0bc6f5de5`, '_self')}> 新增 </Button>
                </div>
            </div>
        );
    }
