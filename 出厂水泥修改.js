...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        if (serchQuery.code) {
            ...
            scriptUtil.excuteScriptService({
                objName: "ZLGL",
                serviceName: "getFinalResult_CCSN",
                                            ...
                                            {item.list.map((node, index) => (
                                                <div style={detailItemStyle}>
                                                    ...
                                                    <input
                                                        ...
                                                        type={node.name.substr(5) == 'BZ' ? 'text' : 'number'}
                                                        placeholder=""
                                                        name="value"
                                                        value={node.value}
    ...
    handleOpenAnalysisResult = () => {
        window.top.zhizhiDispatchAppEvent('reqOpenPublicAccount', {
            ...
            title: '',
            // 下一个页面的URL
            url: `http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_67e915aede514ac690bf189fd527ff9e?orderCode=${this.state.mainInfo.orderCode} `
        })
    }
    //保存主子表
    saveInfo = () => {
