...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            serviceName: "querycementSampleAutoCodeSQLExec6",
            params: inputs,
            cb: (res) => {
        ...
        scriptUtil.excuteScriptService({
            ...
            cb: (res) => {
                ...
                res.result.data.dataSource.find(item => item.code === section.code) ?
                    scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_71303c38c375460980e9950c1d8c7d5e?code=${section.code}&BZ=${section.BZ}&place=${section.place}&cementType=${section.cementType}&createTime=${section.createTime}`, '_self') ://修改页面
                    scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_2cce48f1609b4b27b4a9a1667f7225d2?code=${section.code}&BZ=${section.BZ}&cementType=${section.cementType}&createTime=${section.createTime}`, '_self')//新建页面
            }
        });
