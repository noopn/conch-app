...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            params: { category: '熟料库', factory: '制造一', recordingTime: serchQuery.recordingTime.split(' ')[0], team: serchQuery.team },
            cb: (res) => {
                this.setState({
    ...
    handleSaveClick = () => {
        ...
        Promise.all(this.state.dataSections.map(item => new Promise((resolve, reject) => {
            const updateData = {
                ...
                where: { category: '熟料库', factory: '制造一', recordingTime: this.state.recordingTime, team: this.state.team, id: item.id },
            };
            scriptUtil.excuteScriptService({
            ...
            scriptUtil.openPage('/#/runtime-fullscreen/runtime-fullscreen/Page_884ae7b1347847b88f5d6e7fd76939e8', '_self')
        })
    }
