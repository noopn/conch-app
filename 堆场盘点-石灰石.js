...
class CustomComp extends Component {
    ...
    heapGroup = {
        4001: [
            { heapName: '堆A', group: '4001A' },
            { heapName: '堆B', group: '4001B' },
        ],
        4002: [
            { heapName: '堆A', group: '4002A' },
            { heapName: '堆B', group: '4002B' },
        ],
        4003: [
            { heapName: '堆A', group: '4003A' },
            { heapName: '堆B', group: '4003B' },
        ],
        4004: [
            { heapName: '堆A', group: '4004A' },
            { heapName: '堆B', group: '4004B' },
        ]
    }
    componentDidMount() {
        //隐藏滚轮
    ...
    handleSubmit = () => {
        ...
        Promise.all(
            ...
            .then(() => {
                ...
                setTimeout(() => {
                    scriptUtil.openPage('#/runtime-fullscreen/runtime-fullscreen/Page_a80ac990a2a6461590da5c7fe9ef5278', '_self');
                }, 800)
            })
        // })
