        ...
        scriptUtil.excuteScriptService({
            ...
            cb: (res) => {
                ...
                res.result.data.dataSource.find(item => item.orderCode === section.orderCode) ?
                    scriptUtil.openPage(`http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_a8564c46e97944dba0bee15e26ede5f9?code=${section.code}&orderCode=${section.orderCode}&createTime=${section.createTime}`, '_self') ://修改页面
                    scriptUtil.openPage(`http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_7f39b6ce03204ae48e55198cd16a0146?code=${section.code}&orderCode=${section.orderCode}&createTime=${section.createTime}`, '_self')//新建页面
            }
        });
