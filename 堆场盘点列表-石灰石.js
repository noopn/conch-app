        ...
        return (
            ...
            >
                ...
                {this.state.data.map(section => (
                    <div style={topDivContainerStyle}>
                        <div style={topDescStyle}
                            onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_38a521ef5c88494a9ffb8f3250ff4a43?date=${section.recordtime}&code=${section.whcode}`, '_self')}
                        >
                            {section.whname}
                        </div>
                        <div style={topDescStyle}>
                ...
                <div style={btnContainerStyle}>
                    <Button style={saveBtnStyle} onTouchStart={()=>scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_30f2ba395cc34f07938d383d04c67cb4`, '_self')}> 新增 </Button>
                </div>
            </div>
        );
    }
