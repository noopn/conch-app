...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            params: { category: '熟料库', factory: '制造一' },
            cb: (res) => {
        ...
        return (
            ...
            >
                ...
                {this.state.data.map(section => (
                    <div style={topDivContainerStyle}>
                        <div style={topDescStyle}
                            onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_2439a36c2e904047b303fea13af02535?recordingTime=${section.recordingTime}&team=${section.team}`, '_self')}
                        >
                            {section.recordingTime.split(' ')[0]}
                        </div>
                        <div style={topDescStyle}>
                            {section.team}
                        </div>
                ...
                <div style={btnContainerStyle}>
                    <Button style={saveBtnStyle} onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_579cba9bf4be4d00aa7bc4a8c8d42237`, '_self')}> 新增 </Button>
                </div>
            </div>
        );
    }
