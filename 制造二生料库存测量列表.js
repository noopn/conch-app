...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            params: { category: '生料', factory: '制造二' },
            cb: (res) => {
        ...
        return (
            ...
            >
                ...
                {this.state.data.map(section => (
                    <div style={topDivContainerStyle}>
                        <div style={topDescStyle}
                            onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_ffc8fdf1038a44be8eadb0e34b3c6f51?recordingTime=${section.recordingTime}&team=${section.team}`, '_self')}
                        >
                ...
                <div style={btnContainerStyle}>
                    <Button style={saveBtnStyle} onTouchStart={() => scriptUtil.openPage(`#/runtime-fullscreen/runtime-fullscreen/Page_e0a8c04852984e4dae2ad2ecc167db81`, '_self')}> 新增 </Button>
                </div>
            </div>
        );
    }
