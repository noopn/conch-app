...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            ...
            serviceName: "querycementSampleAutoCodeSQLExec5",
            // params: inputs,
            cb: (res) => {
        ...
        return (
            ...
            >
                ...
                {this.state.records.map(section => (
                    <div style={topDivContainerStyle} >
                        <div style={topDescStyle} onTouchStart={() => { scriptUtil.openPage('http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_344f1b363884430c8a568187c3de260d?code=' + section.code + '&shipName=' + section.shipName, '_self'); }}>
                            {section.code}
                        </div>
