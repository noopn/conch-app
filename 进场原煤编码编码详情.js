...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        if (serchQuery.code) {
            ...
            scriptUtil.excuteScriptService({
                objName: "KZZGL",
                serviceName: "getInfoData",
                params: { code: serchQuery.code, shipName: decodeURI(serchQuery.shipName) },
                cb: (res) => {
        ...
        return (
            ...
            >
                ...
                <div style={listWrapper}>
                    ...
                    <div style={listItemStyle}>
                        <label style={listItemLabel}>物料品种</label>
                        <div style={listItemInput}>{this.state.cementType}</div>
                    ...
                    <div style={listItemStyle}>
                        <label style={listItemLabel}>备注</label>
                        <Input style={listItemInput} value={this.state.BZ} placeHolder='请输入备注' onChange={(e) => this.onInputChange(e, 'BZ')} />
                    </div>
                </div>
    ...
    //保存主子表
    handleEditClick = () => {
        const { code, cementType, shipName, createTime, serialNum, orderCode } = this.state;
        scriptUtil.excuteScriptService({
            objName: "cementSampleAutoCode",
            ...
            cb: (res) => {
                if (200 != res.code) {
                    ...
                    const paramsSub = {
                        cementType, shipName, createTime, serialNum, orderCode, code, status: 1
                    };
                    scriptUtil.excuteScriptService({
                        objName: "cementSampleAutoCode",
