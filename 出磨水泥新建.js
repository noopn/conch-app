...
class CustomComp extends Component {
                                        ...
                                        <div>
                                            {item.list.map(node => (
                                                <div style={detailItemStyle}>
                                                    ...
                                                    <input style={detailItemInputStyle} type={node.name.substr(5) == 'BZ' || node.name.substr(5) == 'ZF' ? 'text' : 'number'}
                                                        placeholder=""
                                                        name="value"
                                                        value={node.value}
    ...
    saveInfo = () => {
        ...
        const params = {
            ...
            "scdate": mainInfo.scDate,
            "fxdate": mainInfo.fxDate,
            "ysType": mainInfo.ysType,
            "cement_mill": mainInfo.snmType,
            // "jcsl": 0,
            "code": mainInfo.code,
        };
        ...
        scriptUtil.excuteScriptService({
            ...
            cb: (res) => {
                ...
                setTimeout(() => {
                    ...
                    scriptUtil.openPage('#/runtime-fullscreen/runtime-fullscreen/Page_8dfb7a621761412ba479f372c8ecfe7a', '_self');
                }, 800);
                // this.initList();
            }
        });
