...
.vertical-center-modal .ant-modal, .ant-modal-wrap .ant-modal{
    width: 100% !important;
}
.vertical-center-modal .ant-modal-content .ant-modal-body, .ant-modal-wrap .ant-modal-content .ant-modal-body{
    padding:0
}
`;
    ...
    renderPhoto = () => {
        return (
            <div style={{ marginBottom: '40px' }}>
                ...
                <div style={topDivContainerStyle}>
                    <div style={photoArea}>
                        <Upload listType='picture' fileList={this.state.bgpic} onPreview={this.onPreview}></Upload>
        ...
        return (
            ...
            >
                <div style={topDivContainerStyle}>
                    ...
                    <div style={topTitleStyle}>到港日期</div>
                </div>
                <div style={topDivContainerStyle}>
                    <div style={topDescStyle}>
                        <Input
