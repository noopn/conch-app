...
class CustomComp extends Component {
    ...
    componentDidMount() {
        ...
        scriptUtil.excuteScriptService({
            objName: "ZLGL",
            serviceName: "getMJNumber",
            params: {},
            cb: (res) => {
                const MJObjs = res.result.map(item => {
                    return {
                        ...item,
                    }
                })
                this.setState({ MJObjs: MJObjs, mainInfo: { ...this.state.mainInfo, scName: _.get(MJObjs, '[0].showName') } });
            }
        });
        ...
        return (
            ...
            >
                ...
                {dataSections.map(section => (
                    <div style={listContainerStyle} key={section.showName}>
    ...
    selectChange = (value) => {
        ...
        let data = Object.assign({}, this.state.mainInfo, { scName: value });
    ...
    handleSaveClick = () => {
        const inputs = '{"orderCode":"' + this.state.mainInfo.orderCode + '"}';
        scriptUtil.excuteScriptService({
            objName: "ZLFXObj6",
    ...
    saveInfo = () => {
        ...
        const params = {
            ...
            "typeName": "WJSL", "typeShowName": "物检熟料", "scName": mainInfo.scName,
            "scdate": mainInfo.createTime, "fxdate": mainInfo.fxDate, "code": mainInfo.code,
            ...
            cb: (res) => {
                ...
                scriptUtil.excuteScriptService({
                    ...
                    cb: (res) => {
                        ...
                        setTimeout(() => {
                            scriptUtil.openPage('http://60.167.69.246:38080/#/runtime-fullscreen/runtime-fullscreen/Page_4b31d759d0ae4dba808a0eca66928503', '_self');
                        }, 1500);
                        return res.result;
                    }
                });
